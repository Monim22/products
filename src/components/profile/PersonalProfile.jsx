...
function PersonalProfile() {
  ...
  const [pwdLength, setPwdLength] = useState(userData.passwordLength);
  ...
  return (
    <div className="flex justify-center h-full max-w-[1000px] w-full mt-14">
      ...
      <div className="w-2/3">
        <div className="flex h-16 px-8 py-4 border-b-2 border-gray-300">
