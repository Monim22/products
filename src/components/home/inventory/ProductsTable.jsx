...
function ProductsTable({
  ...
  return (
    <div className="flex relative">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <td className="px-6 text-xl font-semibold text-center whitespace-no-wrap font font-regular text-supplair-secondary">
                <h3 className="inline">
                  {product.price}{" "}
                  <span className="text-sm font-normal">.DA</span>
                </h3>
              </td>
      ...
      <div
        className={`fixed pt-12 top-0 right-0 h-full bg-white shadow-lg transition-all duration-300 overflow-auto ${
        ...
        {products.map((product) =>
          showDetails === product.productId ? (
            <div key={product.productId} className="p-6">
              ...
              <div className="mb-4">
                ...
                {product.discount ? (
                  <>
                    ...
                    to {new Date(product.discount.endDate).toLocaleDateString()}
                    )
                  </>
                ) : (
                  "No Discount"
              ...
              <div className="mb-4">
                <strong>Product Group:</strong> {product.productsGroupId}
              </div>
              <div className="mb-4">
              ...
              {showOptions === product.productId && (
                <div className="mb-4">
                  <button
                    className="w-40 h-10 px-4 text-lg rounded-lg font-regular hover:text-white hover:bg-supplair-primary text-start mr-2"
